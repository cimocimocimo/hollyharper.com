...
?>
    ...
    <img id="christies-logo" src="<?php bloginfo('template_directory'); ?>/img/christies-logo.png" alt="Christies International Logo" />
    ...
    <div id="copyright">
      <p>
        Copyright &copy; <?php echo date('Y'); ?> Holly Harper
      </p>
    </div>
    <?php
